"""RL configuration for Unitree G1 23DOF AMP locomotion task."""
...
_MOTION_DATA_DIR = os.path.join(
  ...
  "src", "assets", "motions", "g1", "23dof_amp",
)
...
def g1_23dof_amp_ppo_runner_cfg(experiment: str = "baseline") -> RslRlAmpRunnerCfg:
  ...
  return RslRlAmpRunnerCfg(
    ...
    # 23 DOF vs 29 DOF: wrist_pitch/wrist_yaw (4) and waist_pitch/waist_roll (2) removed.
