"""Unitree G1 23DOF AMP Locomotion environment configurations."""
...
def g1_23dof_amp_rough_env_cfg(play: bool = False) -> ManagerBasedRlEnvCfg:
  """Create Unitree G1 23DOF rough terrain AMP configuration."""
  ...
  # 23DOF removes wrist_pitch/wrist_yaw and waist_pitch/waist_roll links.
  # The wrist terminal bodies are left_wrist_roll_rubber_hand / right_wrist_roll_rubber_hand.
  body_names = ("pelvis",
                "left_hip_roll_link",
                "left_knee_link",
  ...
  # Set motion data path for startup loader and reset (23DOF converted data).
  _motion_base = os.path.join(
    os.path.dirname(__file__), "..", "..", "..", "..", "assets", "motions", "g1", "23dof_amp"
  )
